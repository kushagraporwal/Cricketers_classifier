    ...
    dz.on("complete", function (file) {
        ...
        $.post(url, {
            ...
            */
            ...
            let players = ["lionel_messi", "maria_sharapova", "roger_federer", "serena_williams", "virat_kohli", "rohit_sharma", "bhuvneshwar_kumar", "jasprit_bumrah", "rishabh_pant", "hardik_pandya", "kl_rahul", "shardul_thakur", "ravindra_jadeja"];
            ...
            if (match) {
                ...
                $('#resultHolder').html("<h1>"+match.class+"</h1>")
